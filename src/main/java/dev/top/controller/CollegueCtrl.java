...
public class CollegueCtrl {
	...
	public void NouveauCollegue() {
	}

	@RequestMapping(method = RequestMethod.POST, path = "/Ajouter", consumes = MediaType.APPLICATION_JSON_VALUE)
	public ResponseEntity<?> creerUnCollegue(@RequestBody CollegueIhm collegueIhm) {

		// interroger API Collegues
